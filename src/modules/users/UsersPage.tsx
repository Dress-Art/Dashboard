...
const ROLE_BADGE_COLOR: Record<Role, string> = {
    ...
    couturier: 'bg-purple-100 text-purple-800 dark:bg-purple-900/30 dark:text-purple-300',
    agent:     'bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-300',
    livreur:   'bg-orange-100 text-orange-800 dark:bg-orange-900/30 dark:text-orange-300',
    vendeur:   'bg-teal-100 text-teal-800 dark:bg-teal-900/30 dark:text-teal-300',
    client:    'bg-gray-100 text-gray-700 dark:bg-gray-800 dark:text-gray-300',
}

function roleBadgeClass(role: string): string {
    if ((ROLES as readonly string[]).includes(role)) return ROLE_BADGE_COLOR[role as Role]
    return 'bg-gray-200 text-gray-700 dark:bg-gray-800 dark:text-gray-300'
}

function roleLabel(role: string): string {
    if ((ROLES as readonly string[]).includes(role)) return ROLE_LABELS_FR[role as Role]
